...
const CreateGroup: React.FC<CreateGroupProps> = ({ onNavigate }) => {
  ...
  return (
    <>
      <main className="create-group page-offset">
        <div className="container">
          <div className="cg-inner">
            <div className="cg-title">
              <h1 className="text-headline-lg">Start a new group</h1>
              <p className="text-body-md" style={{ color: "var(--color-secondary)", marginTop: 6 }}>
            ...
            <div className="card cg-card">
              ...
              <div className="cg-section">
                <label className="cg-label">GROUP CATEGORY</label>
                <div className="cg-categories">
                  {categories.map(({ icon, label }) => (
                    <button
                      key={label}
                      className={`cg-category-btn ${selectedCategory === label ? "cg-category-btn-active" : ""}`}
